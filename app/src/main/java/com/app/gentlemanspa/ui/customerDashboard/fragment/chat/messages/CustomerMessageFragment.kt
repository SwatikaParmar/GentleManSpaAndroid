...
import com.app.gentlemanspa.ui.customerDashboard.fragment.chat.messages.model.CustomerMessageModel
...
class CustomerMessageFragment : Fragment(), View.OnClickListener {
    lateinit var binding: FragmentCustomerMessageBinding
    private var currentUserId: String? = null
    private var contactsRef: DatabaseReference? = null
    private  var userRef: DatabaseReference? = null
    private val args: CustomerMessageFragmentArgs by navArgs()
    var dialogBuilder: AlertDialog.Builder? = null
    var myDialog: AlertDialog? = null
    var adapter : FirebaseRecyclerAdapter<CustomerMessageModel?, ContactsViewHolder?>? = null
   ...
   /* companion object {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.rvCustomerMessages.layoutManager = mLinearLayoutManager
        initUI()
    }
    ...
    private fun userMessages() {
        ...
        val options= contactsRef?.orderByChild("latest_message/timeStamp").let {
            FirebaseRecyclerOptions.Builder<CustomerMessageModel>()
                .setQuery(it!!, CustomerMessageModel::class.java)
                .build()
        }

        adapter = object : FirebaseRecyclerAdapter<CustomerMessageModel?, ContactsViewHolder?>(options){
            override fun onBindViewHolder(
                holder: ContactsViewHolder,
                @SuppressLint("RecyclerView") position: Int,
                model: CustomerMessageModel
            ) {
                    ...
                    override fun onDataChange(dataSnapshot: DataSnapshot) {
                        if (dataSnapshot.exists()) {
                            ...
                            holder.itemView.setOnClickListener {
                                ...
                                Log.d("UID","uid->$uid")
                                val action =CustomerMessageFragmentDirections.actionCustomerMessageFragmentToCustomerChatFragment(
        ...
        binding.rvCustomerMessages.adapter = adapter
