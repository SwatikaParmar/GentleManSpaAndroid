package com.app.gentlemanspa.ui.customerDashboard.fragment.chat.chat.viewModel
...
class CustomerChatViewModel(private var initialRepository: InitialRepository) : AndroidViewModel(
    Application()
) {
