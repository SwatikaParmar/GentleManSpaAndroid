...
class CompletedAppointmentAdapter(private val dataList:ArrayList<UpcomingServiceAppointmentItem>) : RecyclerView.Adapter<CompletedAppointmentAdapter.ViewHolder>()  {
