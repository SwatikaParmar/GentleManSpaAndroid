package com.app.gentlemanspa.ui.professionalDashboard.fragment.messages
...
import com.app.gentlemanspa.ui.customerDashboard.fragment.messages.MessageFragment.ContactsViewHolder
import com.app.gentlemanspa.ui.customerDashboard.fragment.messages.MessageFragmentDirections
...
import com.app.gentlemanspa.ui.professionalDashboard.fragment.messages.adapter.ProfessionalMessagesAdapter
...
class ProfessionalMessagesFragment : Fragment(), View.OnClickListener {
    ...
    var adapter : FirebaseRecyclerAdapter<MessageModel?, ProfessionalMessagesFragment.ContactsViewHolder?>? = null
    ...
    companion object {
        fun newInstance() = ProfessionalMessagesFragment()
    ...
    override fun onCreateView(
        ...
        currentUserId = "${AppPrefs(requireContext()).getStringPref(PROFESSIONAL_USER_ID)}"
