package com.app.gentlemanspa.ui.customerDashboard.fragment.selectProfessional.viewModel
...
class ProfessionalViewModel (private var initialRepository: InitialRepository) : AndroidViewModel(
    Application()
) {
