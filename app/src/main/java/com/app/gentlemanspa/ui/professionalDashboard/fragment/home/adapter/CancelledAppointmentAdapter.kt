...
import com.app.gentlemanspa.databinding.ItemAppointmentCancelledBinding
...
class CancelledAppointmentAdapter(private val dataList:ArrayList<UpcomingServiceAppointmentItem>)  : RecyclerView.Adapter<CancelledAppointmentAdapter.ViewHolder>()  {

    class ViewHolder(val binding : ItemAppointmentCancelledBinding) : RecyclerView.ViewHolder(binding.root)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding = ItemAppointmentCancelledBinding.inflate(LayoutInflater.from(parent.context),parent,false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.binding.apply {
            tvConfirmed.text ="Cancelled"
            tvServiceName.text=item.professionalName
