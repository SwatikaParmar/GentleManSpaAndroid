package com.app.gentlemanspa.ui.customerDashboard.fragment.chat.messages.viewModel
...
class CustomerMessagesViewModel(private var initialRepository: InitialRepository) : AndroidViewModel(
    Application()
) {
