package com.app.gentlemanspa.ui.professionalDashboard.fragment.requestToManagement.adapter
...
class RequestTypeAdapter(context: Context, private val list: ArrayList<RequestTypeModel>) :
